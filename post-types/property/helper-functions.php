...
if (!function_exists('qodef_re_property_meta_box_functions')) {
    ...
    add_filter('eiddo_qodef_meta_box_post_types_save', 'qodef_re_property_meta_box_functions');
    add_filter('eiddo_qodef_meta_box_post_types_remove', 'qodef_re_property_meta_box_functions');
}
...
if (!function_exists('qodef_re_property_scope_meta_box_functions')) {
    ...
    add_filter('eiddo_qodef_set_scope_for_meta_boxes', 'qodef_re_property_scope_meta_box_functions');
}

if (!function_exists('qodef_re_add_property_to_search_types')) {
    function qodef_re_add_property_to_search_types($post_types)
    {
        $post_types['property'] = esc_html__('Property', 'select-real-estate');

        return $post_types;
    }

    add_filter('eiddo_qodef_search_post_type_widget_params_post_type', 'qodef_re_add_property_to_search_types');
}
...
if (!function_exists('qodef_re_property_enqueue_meta_box_styles')) {
    ...
    add_action('eiddo_qodef_enqueue_meta_box_styles', 'qodef_re_property_enqueue_meta_box_styles');
}
    ...
    function qodef_re_property_add_social_share_option($container)
    {
        eiddo_qodef_add_admin_field(
            array(
                ...
                'default_value' => 'no',
                'label'         => esc_html__('Property', 'select-real-estate'),
                'description'   => esc_html__('Show Social Share for Property Items', 'select-real-estate'),
                'parent'        => $container
            )
        );
    }

    add_action('eiddo_qodef_post_types_social_share', 'qodef_re_property_add_social_share_option', 10, 1);
}
...
if (!function_exists('qodef_re_get_holder_params_archive')) {
    ...
    function qodef_re_get_holder_params_archive()
    {
        ...
        $layout = eiddo_qodef_options()->getOptionValue('real_estate_archive_page_layout');
        if ($layout == 'in-grid') {
...
if (!function_exists('qodef_re_get_archive_property_list')) {
    function qodef_re_get_archive_property_list($qodef_taxonomy_id = '', $qodef_taxonomy_name = '', $qodef_author_id = '', $enable_map_param = '', $enable_filter_param = '', $col_number_param = '')
    {
        ...
        $posts_per_page = 12;
        $number_of_items_option = eiddo_qodef_options()->getOptionValue('real_estate_archive_items_per_page');
        if (!empty($number_of_items_option)) {
            $posts_per_page = $number_of_items_option;
        }

        $col_number = 2;
        $number_of_columns_option = eiddo_qodef_options()->getOptionValue('real_estate_archive_number_of_columns');
        ...
        $col_space = 'medium';
        $space_between_items_option = eiddo_qodef_options()->getOptionValue('real_estate_archive_space_between_items');
        if (!empty($space_between_items_option)) {
            $col_space = $space_between_items_option;
        }

        $image_size = 'full';
        $image_size_option = eiddo_qodef_options()->getOptionValue('real_estate_archive_image_size');
        if (!empty($image_size_option)) {
            $image_size = $image_size_option;
        }

        $enable_filter = 'yes';
        $enable_filter_option = eiddo_qodef_options()->getOptionValue('real_estate_archive_filter');
        ...
        $enable_map = 'yes';
        $enable_map_option = eiddo_qodef_options()->getOptionValue('real_estate_archive_map');
        ...
        $enable_load_more_option = eiddo_qodef_options()->getOptionValue('real_estate_archive_load_more');
        ...
        $html = eiddo_qodef_execute_shortcode('qodef_property_list', $shortcode_params);

        print eiddo_qodef_get_module_part($html);
    }
}
...
if (!function_exists('qodef_re_archive_property_title_display')) {
    ...
    add_filter('eiddo_qodef_show_title_area', 'qodef_re_archive_property_title_display');
}
...
if (!function_exists('qodef_re_single_property_title_display')) {
    ...
    function qodef_re_single_property_title_display($show_title_area)
    {
        if (is_singular('property')) {
            //Override displaying title based on property option
            $show_title_area_meta = eiddo_qodef_get_meta_field_intersect('show_title_area_property_single');
    ...
    add_filter('eiddo_qodef_show_title_area', 'qodef_re_single_property_title_display');
}
...
if (!function_exists('qodef_re_show_reviews_form')) {
    ...
    add_filter('eiddo_qodef_show_comment_form_filter', 'qodef_re_show_reviews_form');
}
...
if (!function_exists('qodef_re_show_comment_list_title')) {
    ...
    add_filter('eiddo_qodef_show_comment_list_title_filter', 'qodef_re_show_comment_list_title');
}
...
if (!function_exists('qodef_re_comment_final_fields')) {
    ...
    add_filter('eiddo_qodef_comment_form_final_fields', 'qodef_re_comment_final_fields', 10, 1);
}
...
if (!function_exists('qodef_re_single_property_content_styles')) {
    function qodef_re_single_property_content_styles()
    {
        ...
        $padding_top = eiddo_qodef_options()->getOptionValue('content_top_padding_property_single');
        if ($padding_top !== '') {
    ...
    add_action('eiddo_qodef_style_dynamic', 'qodef_re_single_property_content_styles');
}
...
if (!function_exists('qodef_re_single_property_sidebar_display')) {
    ...
    function qodef_re_single_property_sidebar_display($sidebar_layout)
    {
        if (is_singular('property')) {
            ...
            if (empty($sidebar_layout_meta)) {
                $sidebar_layout = eiddo_qodef_options()->getOptionValue('property_single_sidebar_layout');
            }
        }
    ...
    add_filter('eiddo_qodef_sidebar_layout', 'qodef_re_single_property_sidebar_display');
}

if (!function_exists('qodef_re_single_property_sidebar_name')) {
    /**
     * Function that checks option for single property sidebar name and overrides it with filter
     */
    function qodef_re_single_property_sidebar_name($sidebar_name)
    {
        if (is_singular('property')) {
            //Override displaying sidebar based on property meta field
            $sidebar_name_meta = get_post_meta(get_the_ID(), 'qodef_custom_sidebar_area_meta', true);

            if (empty($sidebar_name_meta)) {
                $sidebar_name = eiddo_qodef_options()->getOptionValue('property_custom_sidebar_area');
            }
        }
    ...
    add_filter('eiddo_qodef_sidebar_name', 'qodef_re_single_property_sidebar_name');
}
...
if (!function_exists('qodef_re_set_single_property_comments_enabled')) {
    ...
    {
        if (is_singular('property') && eiddo_qodef_options()->getOptionValue('property_single_comments') == 'yes') {
            $comments = true;
        }
    ...
    add_filter('eiddo_qodef_post_type_comments', 'qodef_re_set_single_property_comments_enabled', 10, 1);
}

if (!function_exists('qodef_re_get_single_property')) {
    function qodef_re_get_single_property()
    {
        $item_layout = eiddo_qodef_get_meta_field_intersect('property_single_layout');
...
if (!function_exists('qodef_re_get_real_estate_size_html')) {
    ...
    {
        $item_id = isset($item_id) && !empty($item_id) ? $item_id : get_the_ID();
        $size_label = eiddo_qodef_get_meta_field_intersect('property_size_label', $item_id);
        $size_position = eiddo_qodef_get_meta_field_intersect('property_size_label_position', $item_id);
...
if (!function_exists('qodef_re_get_real_estate_price_html')) {
    ...
    {
        $rate = get_theme_mod('rate-settings');
        $item_id = isset($item_id) && !empty($item_id) ? $item_id : get_the_ID();
        $price_label = eiddo_qodef_get_meta_field_intersect('property_price_label', $item_id);
        $price_position = eiddo_qodef_get_meta_field_intersect('property_price_label_position', $item_id);
        $label_html = $price_html = $html = '';


        if (!empty($price) || $price == '0') {
            $price = number_format($price * $rate, '0', ',', '.');
...
if (!function_exists('qodef_re_get_property_specification_items')) {
    function qodef_re_get_property_specification_items($item_id = '')
    {
        ...
        //Get Bedrooms
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-bedrooms', 'png') . '" alt="' . esc_attr__('Property bedroom icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Bedrooms:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_bedrooms_meta', true);
        $specification_items[] = $item;

        //Get Bathrooms
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-bathrooms', 'png') . '" alt="' . esc_attr__('Property bathroom icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Bathrooms:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_bathrooms_meta', true);
        $specification_items[] = $item;

        //Get Property Size
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-property-size', 'png') . '" alt="' . esc_attr__('Property size icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Property size:', 'select-real-estate');
        ...
        //Get Floor
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-floor', 'png') . '" alt="' . esc_attr__('Property floor icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Floor:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_floor_meta', true);
        $specification_items[] = $item;

        //Get Total Floors
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-total-floors', 'png') . '" alt="' . esc_attr__('Property total floors icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Total floors:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_total_floors_meta', true);
        $specification_items[] = $item;

        //Get Year Built
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-year-built', 'png') . '" alt="' . esc_attr__('Property year built icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Year Built:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_year_built_meta', true);
        $specification_items[] = $item;

        //Get Heating
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-heating', 'png') . '" alt="' . esc_attr__('Property heating icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Heating:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_heating_meta', true);
        $specification_items[] = $item;

        //Get Accommodation
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-accommodation', 'png') . '" alt="' . esc_attr__('Property accommodation icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Accommodation:', 'select-real-estate');
...
if (!function_exists('qodef_re_get_property_additional_specification_items')) {
    function qodef_re_get_property_additional_specification_items($item_id = '')
    {
        ...
        //Get Ceiling Height
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-ceiling-height', 'png') . '" alt="' . esc_attr__('Property ceiling height icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Ceiling height:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_ceiling_height_meta', true);
        $specification_items[] = $item;

        //Get Parking
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-parking', 'png') . '" alt="' . esc_attr__('Property parking icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Parking:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_parking_meta', true);
        $specification_items[] = $item;

        //Get Distance from Center
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-d-f-center', 'png') . '" alt="' . esc_attr__('Property distance from center icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('From center:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_from_center_meta', true);
        $specification_items[] = $item;

        //Get Publication Date
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-publication-date', 'png') . '" alt="' . esc_attr__('Property publication date', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Publication date:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_publication_date_meta', true);
        $specification_items[] = $item;

        //Get Area Size
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-area-size', 'png') . '" alt="' . esc_attr__('Property area size icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Area size:', 'select-real-estate');
        ...
        //Get Garages
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-garages', 'png') . '" alt="' . esc_attr__('Property garages icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Garages:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_garages_meta', true);
        $specification_items[] = $item;

        //Get Garages Size
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-garages-size', 'png') . '" alt="' . esc_attr__('Property garages size icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Garages size:', 'select-real-estate');
        ...
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-additional-space', 'png') . '" alt="' . esc_attr__('Property additional space icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Additional space:', 'select-real-estate');
        ...
        if (empty($_POST) || !isset($_POST) || !isset($_POST['data'])) {
            ...
            if (wp_verify_nonce($nonce, 'qodef_re_validate_property_item_enquiry')) {
                ...
                if ($email_data['name']) {
                    ...
                    $error = true;
                    $responseMessage = esc_html__('Please insert valid name', 'select-real-estate');
                }
                ...
                if ($email_data['email']) {
                    ...
                    $error = true;
                    $responseMessage = esc_html__('Please insert valid email', 'select-real-estate');
                }
                ...
                if ($email_data['message']) {
                    ...
                    $error = true;
                    $responseMessage = esc_html__('Please fix your message content', 'select-real-estate');
                }
                ...
                if ($error) {
                    ...
                    $messageTemplate = esc_html__('From', 'select-real-estate') . ': ' . $name . "\r\n";
                    $messageTemplate .= esc_html__('Message', 'select-real-estate') . ': ' . $message . "\r\n\n";
                    $messageTemplate .= esc_html__('Message sent via enquiry form on', 'select-real-estate') . ' ' . get_bloginfo('name') . ' - ' . esc_url(home_url('/'));

                    $messageSubject = esc_html__('New Enquiry Form', 'select-real-estate');
                    ...
                    if ($mail_sent) {
                        $success_message = eiddo_qodef_options()->getOptionValue('property_success_message_text');
                        $success_message = $success_message !== '' ? $success_message : esc_html__('Thank you for sending message. You will be contacted soon.', 'select-real-estate');
                        $responseMessage = $success_message;
                        qodef_re_ajax_status('success', $responseMessage);
                    } else {
                        $fail_message = eiddo_qodef_options()->getOptionValue('property_fail_message_text');
                        $fail_message = $fail_message !== '' ? $fail_message : esc_html__('An error occurred during message sending. Please try again.', 'select-real-estate');
                        $responseMessage = $fail_message;
                        qodef_re_ajax_status('error', $responseMessage);
                    }
                }
            } else {
                qodef_re_ajax_status('error', esc_html__('Bad form data sent', 'select-real-estate'));
            }
        }
    }
