...
if(!isset($list_image) || empty($list_image) || $params['use_featured_meta'] == 'no') {
...
<div class="qodef-pli-image">
    <img itemprop="image" src="<?php echo esc_url($list_image); ?>" alt="<?php esc_attr_e('Property Featured Image', 'select-real-estate'); ?>" />
</div>