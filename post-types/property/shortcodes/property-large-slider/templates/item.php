...
$bedroom = get_post_meta($id, 'qodef_property_bedrooms_meta', true);
...
<div class="qodef-pls-item">
    <div class="qodef-item-featured-image" <?php eiddo_qodef_inline_style($styles['qodef-item-featured-image']); ?>></div>
