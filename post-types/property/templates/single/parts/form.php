<div class="qodef-property-enquiry-holder">
    <div class="qodef-property-enquiry-inner">
        ...
        <form class="qodef-property-enquiry-form qodef-style-form" method="POST">
            <input type="text" name="enquiry-name" id="enquiry-name" placeholder="<?php esc_attr_e( 'Your Full Name', 'select-real-estate' );?>" required pattern=".{6,}">
            <input type="email" name="enquiry-email" id="enquiry-email" placeholder="<?php esc_attr_e( 'Your E-mail Address', 'select-real-estate' );?>" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
            <textarea name="enquiry-message" id="enquiry-message" placeholder="<?php esc_attr_e( 'Your Message', 'select-real-estate' );?>" required rows="6"></textarea>
