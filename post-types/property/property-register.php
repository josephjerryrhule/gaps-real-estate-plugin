...
class PropertyRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        ...
        register_post_type( $this->base,
            array(
                'labels' => array(
                    'name'          => esc_html__( 'Select Properties','select-real-estate' ),
                    'singular_name' => esc_html__( 'Select Property','select-real-estate' ),
                    'add_item'      => esc_html__( 'New Property','select-real-estate' ),
                    'add_new_item'  => esc_html__( 'Add New Property','select-real-estate' ),
                    'edit_item'     => esc_html__( 'Edit Property','select-real-estate' )
                ),
                'public'        => true,
                'has_archive'   => true,
    ...
    private function registerTaxonomies() {
        foreach($this->taxonomies as $key=>$value) {
            $labels = array(
                ...
                'singular_name'     => sprintf( esc_html__( 'Property %s', 'select-real-estate' ), $value['singular_name'] ),
                'search_items'      => sprintf( esc_html__( 'Search Property %s', 'select-real-estate' ), $value['plural_name'] ),
                'all_items'         => sprintf( esc_html__( 'All Property %s', 'select-real-estate' ), $value['plural_name'] ),
                ...
                'edit_item'         => sprintf( esc_html__( 'Edit Property %s', 'select-real-estate' ), $value['singular_name'] ),
                'update_item'       => sprintf( esc_html__( 'Update Property %s', 'select-real-estate' ), $value['singular_name'] ),
                'add_new_item'      => sprintf( esc_html__( 'Add New Property %s', 'select-real-estate' ), $value['singular_name'] ),
                'new_item_name'     => sprintf( esc_html__( 'New Property %s Name', 'select-real-estate' ), $value['singular_name'] ),
                'not_found'         => sprintf( esc_html__( 'No Property %s Found', 'select-real-estate' ), $value['plural_name'] ),
                'menu_name'         => sprintf( esc_html__( 'Property %s', 'select-real-estate' ), $value['plural_name'] ),
            );
    ...
    private function postTaxonomiesParams() {
        ...
        $post_taxonomies['property-type'] = array(
            'singular_name' => esc_html__('Type', 'select-real-estate'),
            'plural_name' => esc_html__('Types', 'select-real-estate'),
        ...
        $post_taxonomies['property-feature'] = array(
            'singular_name' => esc_html__('Feature', 'select-real-estate'),
            'plural_name' => esc_html__('Features', 'select-real-estate'),
        ...
        $post_taxonomies['property-status'] = array(
            ...
            'plural_name' => esc_html__('Statuses', 'select-real-estate'),
        ...
        $post_taxonomies['property-county'] = array(
            'singular_name' => esc_html__('County/State', 'select-real-estate'),
            'plural_name' => esc_html__('Counties/States', 'select-real-estate'),
        ...
        $post_taxonomies['property-city'] = array(
            'singular_name' => esc_html__('City', 'select-real-estate'),
            'plural_name' => esc_html__('Cities', 'select-real-estate'),
        ...
        $post_taxonomies['property-neighborhood'] = array(
            'singular_name' => esc_html__('Neighborhood', 'select-real-estate'),
            'plural_name' => esc_html__('Neighborhoods', 'select-real-estate'),
