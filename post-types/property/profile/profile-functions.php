...
if ( ! function_exists( 'qodef_re_add_property' ) ) {
	function qodef_re_add_property() {
		if ( empty( $_POST ) || ! isset( $_POST ) ) {
			...
			$dashboard_url = apply_filters( 'qodef_membership_filter_add_property_redirect_url', qodef_membership_get_dashboard_page_url() );
...
if ( ! function_exists( 'qodef_re_edit_property' ) ) {
	function qodef_re_edit_property() {
		if ( empty( $_POST ) || ! isset( $_POST ) ) {
			...
			$dashboard_url = apply_filters( 'qodef_membership_filter_edit_property_redirect_url', qodef_membership_get_dashboard_page_url() );
