		...
		protected function setParams() {
			$this->params = array(
				...
				array(
					'type'  => 'textfield',
					'name'  => 'property_id',
					'title' => esc_html__('Property ID. If empty, current page ID will be used', 'select-real-estate')
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'display_image',
                ...
                <div class="qodef-contact-holder">
					<?php if ( $display_image ) { ?>
                        <div class="qodef-contact-image">
							...
							?>
							<?php print eiddo_qodef_get_module_part($profile_image); ?>
                        </div>
					<?php } ?>
					...
					<?php if ( $display_website && !empty($user_website) ) { ?>
                        <div class="qodef-contact-website">
                            ...
                            <span class="qodef-contact-label">
                            <a href="<?php echo esc_url($user_website) ?>" target="_blank">
							...
							<?php if ( is_array($social_networks) && count($social_networks) ) { ?>
                                <div class="qodef-contact-social-icons clearfix">
									<?php foreach ( $social_networks as $network ) { ?>
                                        <a itemprop="url" href="<?php echo esc_url($network['link']) ?>"
                                           target="_blank">
