...
if ( ! function_exists( 'qodef_re_get_taxonomy_icon' ) ) {
    function qodef_re_get_taxonomy_icon($id, $image_field_name = '', $icon_field_name = '') {
        ...
        if($image_field_name !== '') {
            ...
            $type_image = isset($image_original[0]) ? $image_original[0] : '';
...
if ( ! function_exists( 'qodef_re_get_assets_icon_list' ) ) {
	function qodef_re_get_assets_icon_list() {
		$icon_list = array(
			...
			'accommodation'     => esc_html__( 'Accommodation', 'select-real-estate' ),
			'additional-space'  => esc_html__( 'Additional Space', 'select-real-estate' ),
			'area-size'         => esc_html__( 'Area Size', 'select-real-estate' ),
			'bathrooms'         => esc_html__( 'Bathrooms', 'select-real-estate' ),
			'bedrooms'          => esc_html__( 'Bedrooms', 'select-real-estate' ),
			'cable-tv'          => esc_html__( 'Cable TV', 'select-real-estate' ),
			'ceiling-height'    => esc_html__( 'Ceiling Height', 'select-real-estate' ),
